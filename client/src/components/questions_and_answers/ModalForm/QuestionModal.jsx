    ...
    <div id='new-question-modal'>
      <div id='new-question-content'>
        ...
        <form id='submit-question-form' onSubmit={props.submitQuestion}>
          ...
          <p>Your Question?*</p>
          <textarea id="question-body" rows="5" cols="50" maxLength="1000" required></textarea>
          ...
          <p>Your email?*</p>
          <textarea id='question-email' pattern=".+@globex\.com" name="email" id='question-email' rows="2" cols="50"
