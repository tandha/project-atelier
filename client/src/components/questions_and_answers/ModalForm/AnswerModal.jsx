    ...
    <div id='new-answer-modal'>
      <div id='new-answer-content'>
        ...
        <form id='submit-answer-form' onSubmit={props.submitAnswer}>
          ...
          <input name='answer-nickname' type='text' size='61' placeholder='Example: jackson543!' maxLength='60' required></input>
          <p id='QA-note'>For privacy reasons, do not use your full name or email address</p>
          <p>Your email?*</p>
          <input name='answer-email' type='email' size='61' placeholder='jack@email.com' maxLength='60' required></input>
