...
class Answer extends React.Component {
  ...
  renderAnswerHelpfulBtn() {
    if (this.state.AnswerHelpful) {
      return ( <button id='answer-helpful' role='answer-help' disabled > Yes ({this.props.answer.helpfulness + 1}) </button> );
    } else {
      return ( <button id='answer-helpful' role='answer-help' onClick={this.markAnswerHelpful}> Yes ({this.props.answer.helpfulness}) </button> );
    }
  }
